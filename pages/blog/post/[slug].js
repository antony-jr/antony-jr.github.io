		...
		<FadeTop/>
			...
			<Container fluid='md'>
				<Row style={{justifyContent: 'center', alignItems: 'center', textAlign: 'center'}}>
					...
					<div style={{width: '100%', display: 'flex', justifyContent: 'center'}}>
					  <div style={{margin: '10px'}}>
						  {props.frontmatter.tag && <Typography type='p' color='rgba(158,158,158 ,1)'>
							  <BsTag/>{' ' + props.frontmatter.tag + ' '}
						   </Typography>}
					  </div>
			  		  <div style={{margin: '10px'}}>
						  {props.frontmatter.read && <Typography type='p' color='rgba(158,158,158 ,1)'>
							<BsFillClockFill style={{verticalAlign: 'sub'}}/>{' ' + props.frontmatter.read + ' min read'}
						   </Typography>}
					  </div>	
				    	</div>
					</Col>
				...
				<Row style={{justifyContent: 'center', alignItems: 'center', marginTop: '100px'}}>
					...
					<Col style={{textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end'}}>
						<a href='/'>
						<Typography type='h4' font='Dosis Bold'>
							Next
						</Typography>
